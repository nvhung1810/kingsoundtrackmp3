    ...
    Validator.isRequired = function (selector, message) {
        return {
            selector: selector,
            test: function (value) {
                return value ? undefined :  message || 'Both passwords must match'
            }
        };
    }
    ...
    const btnSee = $('.btn-toggle-see')
    const see = $('.icon-see')
    console.log(see)
    const hidden = $('.icon-hidden')
    console.log(hidden)
    const pass = $('.form-control-pass')
    console.log(pass)
    isSee = false
    
    
    btnSee.onclick = function() {
        btnSee.classList.toggle("playing")
    }
